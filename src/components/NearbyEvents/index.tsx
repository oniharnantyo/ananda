...
export const NearbyEvents = () => {
  ...
  const generateTimeRemaining = (datetime: Date) => {
  ...
  return (
    <div className="text-center font-light py-5 bg-primary-blue-three justify-between">
      ...
      <div className="w-1/2 float-right mx-auto">
        ...
        <Timer timeRemaining={generateTimeRemaining(data.date)} />
      </div>
    </div>
  );
};
