...
export const LoginInput = () => {
    ...
    const basicValidation = (username: string, password: string) => {
    ...
    return (
        <div className="text-center font-light">
            <section className="min-h-screen flex items-stretch text-white ">
                <div className="lg:flex w-1/2 hidden bg-asphalt bg-no-repeat relative items-center bg-[url('https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80')]" >
                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-asphalt" >
                    ...
                    <div className="w-full py-6 z-20">
                        <img
                            ...
                            alt="logo vidyasena"
                            className="h-36 flex rounded-lg mx-auto"
                            height='500px'
                            max-width={'40%'}
                        />
                        <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            <div className="pb-2 pt-4">
                                ...
                                <input
                                    ...
                                    className="block w-full p-1 rounded-sm bg-asphalt-secondary"
                                />
                            </div>
                            <div className="pb-2 pt-4">
